<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                @else
                    <div class="flex items-center space-x-4">
                        <a href="{{ route('login') }}" class="text-sm font-semibold text-slate-650 dark:text-slate-350 hover:text-slate-900 dark:hover:text-white transition">Login</a>
                        <a href="{{ route('register') }}" class="px-4 py-2 bg-amber-500 hover:bg-amber-600 text-slate-950 rounded-md text-sm font-bold shadow transition duration-200">Register</a>
                    </div>
                @endauth
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()?->isTeacher())
                <x-responsive-nav-link :href="route('teacher.courses.create')" :active="request()->routeIs('teacher.courses.create')">
                    {{ __('Create Course') }}
                </x-responsive-nav-link>
            @endif
        </div>
